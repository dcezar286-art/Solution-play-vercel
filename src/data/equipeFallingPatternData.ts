/** Padrão FallingPattern — gradientes e posições de animação. */

export function buildFallingPatternBackground(color: string): string {
  const rows = [
    [235, 117.5],
    [252, 126],
    [150, 75],
  ...
  for (const [y, dotY] of rows) {
    patterns.push(
      `radial-gradient(4px 100px at 0px ${y}px, ${color}, transparent)`,
      `radial-gradient(4px 100px at 300px ${y}px, ${color}, transparent)`,
...
export const FALLING_PATTERN_BG_SIZES = [
  "300px 235px",
  "300px 235px",
  "300px 235px",
  "300px 252px",
...
export const FALLING_PATTERN_START_POSITIONS =
...
export const FALLING_PATTERN_END_POSITIONS =
...
export const FALLING_PATTERN_DEFAULTS = {
